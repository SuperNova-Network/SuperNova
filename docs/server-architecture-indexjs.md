...
- The client is built with Vite into `dist/` (multi-page: home, settings, go, 404) and served by Express. The default start script runs the build before launching Express.
